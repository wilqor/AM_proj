...
public interface RemoteService {
    ...
    @PUT("/Backend/api/tags")
    Call<List<Tag>> putTags(@Header("ownerGoogleId") String googleId,
                            @Header("ownerGoogleToken") String ownerGoogleToken,
                            @Body List<Tag> tags);

    @PUT("/Backend/api/relations")
    Call<List<ProductTagRelation>> putRelations(@Header("ownerGoogleId") String googleId,
                            @Header("ownerGoogleToken") String ownerGoogleToken,
                            @Body List<ProductTagRelation> relations);
}
